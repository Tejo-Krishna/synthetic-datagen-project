...
_DEFAULTS: dict = {
    ...
    # LLM narrative mode — always true; narrative generation requires a real LLM backend
    "use_llm": True,
}
...
class PlannerConfig:
    ...
    # LLM narrative mode — always true; DeterministicNarrativeBackend has been removed
    use_llm: bool = True
...
# corpus_query_limit: 10
# seed: null
# use_llm: true    # narrative generation always uses the real LLM backend
